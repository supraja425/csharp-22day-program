...
namespace PatientRegistryConsole
{
    class Program
    {
        ...
        static List<string> oldPatients = new List<string>(); 
        ...
        static void DisplayMenu()
        {
            ...
            Console.WriteLine("7. Display Old Patient Names");
        ...
        static void DisplayOldPatients()
        {

            Console.WriteLine($"\nOLD PATIENT NAMES (Audit History)");
            Console.WriteLine("---------------------------------");
            ...
            // Using foreach - clean and safe iteration
            for (int i = 0; i < oldPatients.Count; i++)
            {
                Console.WriteLine($"  {i + 1}. {oldPatients[i]}");
            }
