...
while (true)
{
    ...
    Console.WriteLine("7. View Revenue Details");
    Console.WriteLine("8. Cartision Explosion Demo");
    Console.WriteLine("9. SplitQuery Demo");
...
static void RevenueAtRiskDashboard()
{
    ...
    {
        Console.WriteLine(
            $"{item.Status,-12} {item.ClaimCount,-10} {item.TotalBilled,-15:N2} {item.TotalReimbursed,-15:N2} {item.Gap,-10:N2}");
    }
    Console.WriteLine($"{"Status",-12} {"Claims",-10} {"Billed",-15} {"Reimbursed",-15} {"Gap",-10}");
    Console.WriteLine("------------------------------------------------------------");
    Console.WriteLine($"REVENUE AT RISK (not Paid) : {revenueAtRisk:N2}");
    Console.WriteLine(
            $"Tracked Entities   : {db.ChangeTracker.Entries().Count()}");
...
static void CartesianExplosionDemo()
{
    ...
    int claimsCount = patient.Encounters
            .SelectMany(e => e.Claims)
            .Count();
    ...
    Console.WriteLine($"Patient Name      : {patient.FullName}");
    Console.WriteLine($"Encounters Loaded : {encounterCount}");
    Console.WriteLine($"Diagnoses Loaded  : {diagnosesCount}");
    Console.WriteLine($"Claims Loaded     : {claimsCount}");
...
static void SplitQueryDemo()
{
    ...
    Console.WriteLine();
    Console.WriteLine("SPLIT QUERY DEMO (Optimized)");
    Console.WriteLine("--------------------------------------------------");
    ...
    int diagnosesCount = patient.Encounters
        .SelectMany(e => e.Diagnoses)
        .Count();
    ...
    Console.WriteLine("PERFORMANCE SUMMARY");
    Console.WriteLine("--------------------------------------------------");
    Console.WriteLine("SQL Statements (Profiler) : ");
